...
public class ContactFetcher {
    ...
    public ArrayList<Contacts> fetchAll() {
        ...
        final Map<String, Contacts> contactsMap = new HashMap<>(c.getCount());
    ...
    public void matchContactNumbers(Map<String, Contacts> contactsMap) {
        // Get numbers
    ...
    public void matchContactEmails(Map<String, Contacts> contactsMap) {
        // Get email
